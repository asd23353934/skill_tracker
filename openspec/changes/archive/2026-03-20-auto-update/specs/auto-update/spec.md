...
Defines the behavior of the automatic update system, including version check via GitHub API,
version comparison logic, asset selection priority, download flow, and launcher mechanism.

...
Defines the behavior of the SoundManager, including builtin sound versioning,
WAV/MP3 playback paths, MCI mutex, legacy migration, and sound import flow.
This system is Windows-only.

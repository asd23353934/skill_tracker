# overlay-window-lifecycle Specification

## Purpose

TBD - created by archiving change 'overlay-window-lifecycle'. Update Purpose after archive.
...
<!-- @trace
source: overlay-window-lifecycle
updated: 2026-03-20
code:

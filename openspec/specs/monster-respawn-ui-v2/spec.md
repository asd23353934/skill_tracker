# monster-respawn-ui-v2 Specification

## Purpose

TBD - created by archiving change 'wire-v2-monster-page'. Update Purpose after archive.
...
<!-- @trace
source: wire-v2-monster-page
updated: 2026-04-23
code:
  - src/ui/app_core.py
  - profiles/預設配置.json
  - verify_monster_page_v2.py
